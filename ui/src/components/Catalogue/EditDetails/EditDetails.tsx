...
import { updateBookDetails, type Book, type BookRequest, type Collection } from "../../../api/ApiClient"
...
export const EditDetails: React.FC<Props> = ({ book, getSaveStatus, getEditedBook, getEditStatus, collections }) => {
    ...
    function submitForm(data: {
        ...
        const bookData: BookRequest = {
            ...
            collectionId: collections.find(c => c.name === data.collection)?.id ?? 0,
            read: readBoolean,
                ...
                <tbody>
                    <tr key={book.id}>
                        ...
                        <td className="input-td">
                            ...
                            />
                            {errors.isbn && (<span className="update-details-error">{errors.isbn.message}</span>)}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select required key={book.id} id="collection" {...register("collection", { required: true })}>
                                {[...collections]
