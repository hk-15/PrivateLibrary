...
import type { FormStatus } from "../../api/ApiClient";
...
export default function SignUpForm() {
  ...
  function submitForm(data: {
    ...
    if (strength != "Strong") {
      setStatus("ERROR");
      setPasswordError(
        "Passwords must be at least 6 characters long and have at least one of each of the following: lowercase and uppercase letters, numbers, special characters",
      );
    }
    signUp(data)
      .then(() => {
        ...
        <input
          ...
          {...register("username", {
            ...
            pattern: {
              value: /^\w{4,12}$/,
              message:
                "Username must be between 4 and 12 characters long and contain only letters, numbers and underscores.",
            },
          })}
        />
      </label>
