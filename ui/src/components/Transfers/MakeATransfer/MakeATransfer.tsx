...
export const MakeATransfer: React.FC<Props> = ({ getRefresh }) => {
  ...
  function submitForm(data: { username: string }) {
    ...
    <div className="new-transfer-container border-spaced-bottom">
      ...
      {showForm && (
        <form onSubmit={handleSubmit(submitForm)}>
          <span className="border-spaced-bottom">
            To transfer books to another user of the library, enter their
            username and search books from your catalogue to add to the request.
          </span>
