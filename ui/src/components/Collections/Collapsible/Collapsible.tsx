...
export const Collapsible: React.FC<IProps> = ({ open, header, books, collections, getRefresh }) => {
                            ...
                            <tbody>
                                {
                                    books.map(b =>
                                        <tr key={b.id}>
                                            ...
                                            {selectBooks && <td><input type="checkbox" id={b.id.toString()} name={b.id.toString()} onChange={(e) => {
