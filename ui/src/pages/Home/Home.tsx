    ...
    if (!loginContext.isLoggedIn) {
        return (
            <Page>
                ...
                <p className="border-spaced-bottom"><a className="login-message-link" href="/login">Join Private Library</a> to catalogue your books, curate collections and share books with friends.</p>
                <Stats />
            </Page>
        )
    };
